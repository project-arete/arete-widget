...
The links below point at the current version (v0.1.0); if a newer version
...
- Apple Silicon: [Arete-Widget-0.1.0-arm64.dmg](https://github.com/project-arete/arete-widget/releases/download/v0.1.0/Arete-Widget-0.1.0-arm64.dmg)
- Intel: [Arete-Widget-0.1.0-x64.dmg](https://github.com/project-arete/arete-widget/releases/download/v0.1.0/Arete-Widget-0.1.0-x64.dmg)
...
[Arete-Widget-Setup-0.1.0.exe](https://github.com/project-arete/arete-widget/releases/download/v0.1.0/Arete-Widget-Setup-0.1.0.exe)
...
1. Download: [Arete-Widget-0.1.0-x86_64.AppImage](https://github.com/project-arete/arete-widget/releases/download/v0.1.0/Arete-Widget-0.1.0-x86_64.AppImage)
